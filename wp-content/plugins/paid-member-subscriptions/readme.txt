...
= 2.1.3 =
* Feature: Usage tracking functionality - [learn more](https://www.cozmoslabs.com/docs/paid-member-subscriptions/usage-tracking/)
...
= 1.9.3 =
* Compatibility changes for the SCA ready Stripe Payment Intents integration.[Learn more](https://www.cozmoslabs.com/docs/paid-member-subscriptions/add-ons/stripe-payment-gateway/?utm_source=wp.org&utm_medium=pms-description-page&utm_campaign=PMSFree#Strong_Customer_Authentication)
...
= 1.8.8 =
* Release: Elementor Content Restriction - you can now apply PMS restrictions directly to widgets or sections. [Read more](https://www.cozmoslabs.com/docs/paid-member-subscriptions/integration-with-other-plugins/elementor/)
