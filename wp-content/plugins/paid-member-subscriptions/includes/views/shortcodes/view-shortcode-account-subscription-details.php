...
<table
    class="pms-account-subscription-details-table pms-account-subscription-details-table__<?php echo esc_attr( $subscription->subscription_plan_id ); ?>">
    <tbody>
        ...
        <tr class="pms-account-subscription-details-table__start-date">
            ...
            <td><?php echo ( ! empty( $subscription->start_date ) ? esc_html( ucfirst( date_i18n( get_option('date_format'), strtotime( $subscription->start_date ) ) ) ) : '' ); ?>
            </td>
        </tr>
        ...
        <tr class="pms-account-subscription-details-table__expiration-date">
            ...
            <td><?php echo ( ! empty( $subscription->expiration_date ) ? esc_html( ucfirst( date_i18n( get_option('date_format'), strtotime( $subscription->expiration_date ) ) ) ) : esc_html__( 'Unlimited', 'paid-member-subscriptions' ) ); ?>
            </td>
        </tr>
        <?php endif; ?>
        ...
        <tr class="pms-account-subscription-details-table__trial">
            ...
            <td><?php echo esc_html( ucfirst( date_i18n( get_option('date_format'), strtotime( $subscription->trial_end ) ) ) ); ?>
            </td>
        </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td><?php echo wp_kses_post( sprintf( _x( '%s on %s', '[amount] on [date]', 'paid-member-subscriptions' ), pms_format_price( $subscription->billing_amount, pms_get_active_currency() ), ucfirst( date_i18n( get_option('date_format'), strtotime( $subscription->billing_next_payment ) ) ) ) ); ?>
            </td>
        </tr>
        <?php endif; ?>
