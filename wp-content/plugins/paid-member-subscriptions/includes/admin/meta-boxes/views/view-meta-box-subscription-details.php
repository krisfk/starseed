...
<div class="pms-meta-box-field-wrapper">
    ...
    <label for="pms-subscription-plan-description" class="pms-meta-box-field-label"><?php esc_html_e( 'Description', 'paid-member-subscriptions' ); ?></label>
    ...
    <p class="description"><?php esc_html_e( 'A description for this subscription plan. This will be displayed on the register form.', 'paid-member-subscriptions' ); ?></p>
...
<div class="pms-meta-box-field-wrapper">
    ...
    <p class="description"><?php esc_html_e( 'Set the subscription duration. Leave 0 for unlimited.', 'paid-member-subscriptions' ); ?></p>
...
<div class="pms-meta-box-field-wrapper">
    ...
    <label for="pms-subscription-plan-price" class="pms-meta-box-field-label"><?php esc_html_e( 'Price', 'paid-member-subscriptions' ); ?></label>

    <input type="text" id="pms-subscription-plan-price" name="pms_subscription_plan_price" class="small" value="<?php echo esc_attr( $subscription_plan->price ); ?>" /> <?php echo esc_html( pms_get_active_currency() ); ?>

    <p class="description"><?php esc_html_e( 'Amount you want to charge people who join this plan. Leave 0 if you want this plan to be free.', 'paid-member-subscriptions' ); ?></p>
...
<?php if( pms_payment_gateways_support( pms_get_active_payment_gateways(), 'subscription_sign_up_fee' ) ) : ?>
    <div class="pms-meta-box-field-wrapper">
        ...
        <p class="description"><?php esc_html_e( 'Amount you want to charge people upfront when subscribing to this plan.', 'paid-member-subscriptions' ); ?></p>
...
<?php if( pms_payment_gateways_support( pms_get_active_payment_gateways(), 'subscription_free_trial' ) ) : ?>
    <div class="pms-meta-box-field-wrapper">
        ...
        <p class="description"><?php esc_html_e( 'The free trial represents the amount of time before charging the first recurring payment. The sign-up fee applies regardless of the free trial.', 'paid-member-subscriptions' ); ?></p>
...
<?php if( pms_payment_gateways_support( pms_get_active_payment_gateways(), 'recurring_payments' ) ) : ?>
    ...
    <div class="pms-meta-box-field-wrapper">
        ...
        <p class="description"><?php esc_html_e( 'Select renewal type. You can either allow the customer to opt in, force automatic renewal or force no renewal.', 'paid-member-subscriptions' ); ?></p>
...
<div class="pms-meta-box-field-wrapper">
    ...
    <label for="pms-subscription-plan-status" class="pms-meta-box-field-label"><?php esc_html_e( 'Status', 'paid-member-subscriptions' ); ?></label>
    ...
    <p class="description"><?php esc_html_e( 'Only active subscription plans will be displayed to the user.', 'paid-member-subscriptions' ); ?></p>
...
<div class="pms-meta-box-field-wrapper">
    ...
    <label for="pms-subscription-plan-user-role" class="pms-meta-box-field-label"><?php esc_html_e( 'User role', 'paid-member-subscriptions' ); ?></label>
    ...
    <select id="pms-subscription-plan-user-role" name="pms_subscription_plan_user_role">
        ...
        <?php
            if( !pms_user_role_exists( 'pms_subscription_plan_' . $subscription_plan->id ) )
                echo '<option value="create-new">' . esc_html__( '... Create new user role from this Subscription Plan', 'paid-member-subscriptions' ) . '</option>';
            else
    ...
    <p class="description"><?php esc_html_e( 'Select which user role to associate with this subscription plan.', 'paid-member-subscriptions' ); ?></p>
