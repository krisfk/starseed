...
function pms_should_use_old_merge_tags(){

    if( defined( 'PMS_INV_VERSION' ) && version_compare( PMS_INV_VERSION, '1.2.3' ) == -1 )
        return true;

    if( defined( 'PMS_ER_VERSION' ) && version_compare( PMS_ER_VERSION, '1.1.3' ) == -1 )
        return true;

    if( defined( 'PMS_GM_VERSION' ) && version_compare( PMS_GM_VERSION, '1.1.3' ) == -1 )
        return true;

    if( defined( 'PMS_STRIPE_VERSION' ) && version_compare( PMS_STRIPE_VERSION, '1.4.1' ) == -1 )
        return true;
