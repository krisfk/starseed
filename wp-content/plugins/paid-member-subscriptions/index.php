...
Class Paid_Member_Subscriptions {
    ...
    public function init_dependencies() {
        ...
        if( pms_should_use_old_merge_tags() === true ){
            if( file_exists( PMS_PLUGIN_DIR_PATH . 'includes/class-merge-tags-old.php' ) )
                include_once PMS_PLUGIN_DIR_PATH . 'includes/class-merge-tags-old.php';
        } else {
