        ...
        */
        public function process_data() {
            ...
            if( isset( $_REQUEST['pms-action'] ) && $_REQUEST['pms-action'] == 'duplicate_discount_code' && isset( $_REQUEST['post_id'] ) ) {
                PMS_Discount_Code::duplicate( (int)esc_attr( $_REQUEST['post_id'] ) );
            }
        ...
        public function add_post_row_actions($actions, $post){
            ...
            */
             ...
             */
            $duplicate = '<a href="' . esc_url( wp_nonce_url( add_query_arg( array( 'pms-action' => 'duplicate_discount_code', 'post_id' => $post->ID ) ), 'pms_discount_code_nonce' ) ) . '">' . __( 'Duplicate', 'paid-member-subscriptions' ) . '</a>';
