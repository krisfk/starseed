...
<div class="inner-container  mt-5 text-center">
    <div class="row align-items-center justify-content-center gx-5">
        ...
        <div class="text-center">
            <a href="<?php echo get_site_content();?>/energy-meditation-content-1" class="lang-track-a"> <img
                    src="http://64.227.13.14/starseed/wp-content/uploads/2021/10/lang-1.jpg" alt="">
                <div>廣東話專區</div>
            </a>

            <a href="<?php echo get_site_content();?>/energy-meditation-content-2" class="lang-track-a"> <img
