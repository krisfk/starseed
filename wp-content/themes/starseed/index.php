...
<div class="row align-items-center mt-0">
    ...
    <div class="col-6"><img class="humans-img" src="<?php echo get_template_directory_uri();?>/assets/images/humans.png"
            alt="">
    </div>
</div>
...
<div class="bottom-container-wrapper">
    <div class="container">
        ...
        <div class="row align-items-center position-relative h-100">
            ...
            <div class="col-6 h-100 position-relative key-bg">
            ...
            <div class="col-6  position-relative bud-bg h-100">
